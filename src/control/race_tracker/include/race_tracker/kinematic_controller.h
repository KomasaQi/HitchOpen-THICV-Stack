#ifndef RACE_TRACKER_KINEMATIC_CONTROLLER_H
#define RACE_TRACKER_KINEMATIC_CONTROLLER_H
...
/**
 * @brief 基于车辆运动学的MPC控制器（控制油门/刹车，和转向角跟踪目标速度和位置）
 */
class KinematicController : public ControllerPluginBase {
public:
    KinematicController();
    ~KinematicController() override = default;
    ...
    std::string getName() const override { return "KinematicController"; }
...
#endif // RACE_TRACKER_KINEMATIC_CONTROLLER_H
