#ifndef RACE_TRACKER_LTV_TRACKER_H
#define RACE_TRACKER_LTV_TRACKER_H
...
class LTVTracker : public ControllerPluginBase {
public:
    LTVTracker();
    ~LTVTracker() override = default;
    ...
    std::string getName() const override { return "LTVTracker"; }
...
#endif // RACE_TRACKER_LTV_TRACKER_H
