...
droll = 0.0 # imu测得的侧倾角速度

x2_acc = 0.0 # imu测得的x向加速度   
y2_acc = 0.0 # imu测得的y向加速度
z2_acc = 0.0 # imu测得的z向加速度
droll2 = 0.0 # imu测得的侧倾角速度

roll2_angle = 0.0 # imu测得侧倾角
roll_angle = 0.0 
...
def Steering_and_Speed_Ctrl(x_pos,y_pos):
    global ref_head,heading,pose1_x,pose1_y,vel_true,ref_vel,acc_cmd,acc_limit,delta_cmd
