...
file_paths["track_name"] = "IMS_track"                                    # Indianapolis Motor Speed Way F1 2007
...
if not parser.read(os.path.join(file_paths["module"], "params", file_paths["veh_params_file"]),encoding='utf-8'):
