...
def receive_data():
    open_port()
    pub_odom=rospy.Publisher('odom_message2',Odometry,queue_size=1)
    pub_imu=rospy.Publisher('imu_message2',Imu,queue_size=1)
    pub_roll=rospy.Publisher('roll_message2',Float32,queue_size=1)
    pub_pitch=rospy.Publisher('pitch_message2',Float32,queue_size=1)
    pub_heading=rospy.Publisher('heading_message2',Float32,queue_size=1)
